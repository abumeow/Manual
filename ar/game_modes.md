...
لكشف الموقع التقريبي لمخبأ الأسلحة أثناء نمط Insurgency، يجب جمع معلومات استخباراتية. يحتاج فريق التحالف إلى 50 نقطة معلومات ليتم الكشف عن المخزن بعد 5 دقائق. يتم كسب أو فقدان النقاط كالتالي:

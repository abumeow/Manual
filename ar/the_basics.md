...
* تتضمن بعض الخرائط **نقاط ظهور بالمظلات**، لمحاكاة عمليات الإنزال الجوي. وتظهر هذه النقاط على الخريطة المصغرة على هيئة علامات ظهور متحركة. اختر إحداها، وستظهر في ساحة المعركة بمظلة تُفتح تلقائيًا.
